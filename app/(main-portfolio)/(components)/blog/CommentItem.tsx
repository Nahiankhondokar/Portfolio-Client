                    ...
                    <div className="flex items-center gap-4 mt-2 ml-2">
                        {!comment.parent_id && (
                            <button
                                ...
                                className="flex items-center gap-1 text-[10px] font-black uppercase tracking-widest text-zinc-500 hover:text-yellow-500 transition-colors"
                            >
                                <Reply size={12} />
                                Reply
                            </button>
                        ...
                        {isReplying && (
                            ...
                            >
                                <textarea
                                    ...
                                    className="w-full bg-zinc-950 border border-zinc-800 rounded-xl p-3 text-sm text-zinc-300 focus:outline-none focus:border-yellow-500 transition-colors min-h-[100px] resize-none"
                                />
                                <div className="flex justify-end mt-2 gap-2">
                                    ...
                                    <button
                                        ...
                                        className="px-4 py-2 bg-yellow-500 text-black text-[10px] font-black uppercase tracking-widest rounded-lg hover:bg-white transition-colors disabled:opacity-50"
                                    >
