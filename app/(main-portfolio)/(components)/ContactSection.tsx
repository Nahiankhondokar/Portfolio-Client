                ...
                <div className="lg:col-span-1 space-y-8">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center gap-4">
                            <div className="bg-[#252525] p-3 rounded-full text-indigo-400">
                                <MapPin size={24} />
                            </div>
                            <div>
                    ...
                    <Form {...form}>
                        ...
                        >
                                    ...
                                    <FormItem>
                                        <FormControl>
                                            <Input
                                                ...
                                                {...field}
                                                className="bg-[#252525] border-none rounded-2xl px-6 py-6 focus-visible:ring-2 focus-visible:ring-indigo-500 text-white placeholder:text-gray-500 uppercase text-xs font-bold"
                                            />
                                        </FormControl>
                                    ...
                                    <FormItem className="md:col-span-2">
                                        <FormControl>
                                            <Textarea
                                                ...
                                                rows={6}
                                                {...field}
                                                className="bg-[#252525] border-none rounded-2xl px-6 py-4 focus-visible:ring-2 focus-visible:ring-indigo-500 text-white placeholder:text-gray-500 uppercase text-xs font-bold resize-none"
                                            />
                                        </FormControl>
                                        <FormMessage className="text-red-500 text-xs ml-4" />
                                    </FormItem>
                            ...
                            <button
                                ...
                                className="w-fit flex items-center gap-4 border-2 border-indigo-500 rounded-2xl pl-8 pr-2 py-2 font-bold uppercase tracking-wider hover:bg-indigo-500 hover:text-white transition-all group disabled:opacity-50"
                            >
                                {form.formState.isSubmitting ? "Sending..." : "Send Message"}
                                <span className="bg-indigo-500 text-white p-3 rounded-full group-hover:bg-indigo-950 transition-colors">
                                    <Send size={18} />
                                </span>
                            </button>
                        </form>
