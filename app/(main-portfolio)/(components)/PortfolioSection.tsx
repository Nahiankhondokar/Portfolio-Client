            ...
            >
                {portfolios.map((portfolio) => (
                    <motion.a
                        ...
                        className="group relative block bg-zinc-900 rounded-[2rem] overflow-hidden border border-zinc-800 hover:border-indigo-500/50 transition-colors duration-500 shadow-xl"
                    >
                        {/* Image Container */}
                        ...
                        <div className="p-8 relative">
                            {/* Category Tag */}
                            <span className="text-[10px] uppercase tracking-[3px] text-indigo-400 font-bold mb-2 block">
                                Featured Project
                            </span>
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <div className="w-10 h-10 rounded-full bg-zinc-800 flex items-center justify-center text-white group-hover:bg-indigo-500 group-hover:text-white transition-all duration-300">
                        ...
                        {/* Hover Border Glow */}
                        <div className="absolute inset-0 border-2 border-transparent group-hover:border-indigo-500/20 rounded-[2rem] pointer-events-none transition-colors" />
                    </motion.a>
                ))}
            </motion.div>
        </section>
