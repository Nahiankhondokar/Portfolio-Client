        ...
        >
            ...
            <div className="container mx-auto px-4 sm:px-6 relative z-10">
                <header className="mb-12 lg:mb-20 text-center lg:text-left">
                    ...
                    <div className="h-1 w-16 sm:w-20 bg-indigo-500 mt-4 mx-auto lg:mx-0" />
                </header>
                    ...
                    <div className="lg:col-span-7 space-y-8 lg:space-y-12">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-6">
                            {infoItems.map((item, idx) => (
                                <div key={idx} className="group border-b border-zinc-900 pb-3 sm:border-none sm:pb-0">
                                    ...
                                    <p className="text-sm sm:text-base text-zinc-200 font-medium group-hover:text-indigo-400 transition-colors truncate">
                                        {item.value}
                                    </p>
                                </div>
                            ))}
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 pt-4">
                            <button
                                ...
                                className="flex-1 sm:flex-none flex items-center justify-center gap-3 bg-indigo-500 text-white px-8 py-4 rounded-xl font-black uppercase text-xs tracking-widest hover:bg-indigo-400 transition-all active:scale-95 shadow-[0_10px_30px_rgba(99,102,241,0.2)]"
                            >
                    ...
                    <div className="lg:col-span-5 grid grid-cols-2 gap-3 sm:gap-4">
                        {metrics.map((stat: Metrics, i) => (
                            <motion.div
                                key={i}
                                whileHover={{ y: -5 }}
                                className="bg-zinc-900/40 border border-zinc-800/50 p-6 sm:p-8 rounded-2xl flex flex-col justify-center items-center text-center group hover:border-indigo-500 transition-colors"
                            >
                                <span className="text-3xl sm:text-4xl font-black text-indigo-400 mb-1 group-hover:scale-110 transition-transform">
                                    {stat.value}
                                </span>
                        ...
                        >
                            <div className="flex items-center justify-between p-5 border-b border-zinc-900">
                                ...
                                <button
                                    ...
                                    className="bg-indigo-500 text-white px-4 py-2 rounded-full text-xs font-black uppercase tracking-widest ml-auto hover:bg-indigo-400"
                                >
                                    Close
                                </button>
                            </div>
