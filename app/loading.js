...
const Loading = () => {
  return (
    <div className="fixed inset-0 z-[100] flex flex-col items-center justify-center bg-black">
      ...
      <div className="absolute w-64 h-64 bg-indigo-500/5 rounded-full blur-[120px] animate-pulse" />
      ...
      <div className="relative flex flex-col items-center">
        ...
        <div className="relative w-24 h-24 mb-8">
          ...
          {/* Pulsing Inner Core */}
          <motion.div
            className="absolute inset-4 bg-indigo-500 rounded-2xl flex items-center justify-center shadow-[0_0_30px_rgba(99,102,241,0.25)]"
            animate={{
              scale: [1, 1.1, 1],
              opacity: [0.8, 1, 0.8]
            }}
