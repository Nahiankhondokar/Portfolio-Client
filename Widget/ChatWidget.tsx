        ...
        <div className="flex flex-col h-full bg-black border border-zinc-800 rounded-3xl overflow-hidden shadow-2xl">
            ...
            <div className="p-4 bg-zinc-900/30 border-t border-zinc-800">
                <form
                    ...
                    className="relative flex items-center gap-2 bg-zinc-900 border border-zinc-800 rounded-2xl p-1.5 focus-within:border-indigo-500/50 transition-all"
                >
                    <Input
                        value={input}
                    ...
                    <Button
                        ...
                        size="icon"
                        disabled={!input.trim()}
                        className="bg-indigo-500 hover:bg-indigo-600 text-white rounded-xl shrink-0 shadow-lg transition-transform active:scale-95 disabled:opacity-50 disabled:grayscale"
                    >
